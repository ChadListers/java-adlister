    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-6">
                <h6>About</h6>
                <p class="text-justify">Chadlister.com is an initiative to help make selling easier. Chadlister focuses on providing the most user friendly experience to sell and buy from other users. We will help Sellers maximize profits and for buyers to find what they need.</p>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-sm-6 col-xs-12">
                <p class="copyright-text">Chadlister &copy; 2022 All Rights Reserved by
                    <a href="#">Chadlister</a>.
                </p>
            </div>
